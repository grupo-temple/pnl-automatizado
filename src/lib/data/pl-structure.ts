...
export const PL_STRUCTURE: PLRow[] = [
  {
    id: 's_ingresos', label: 'INGRESOS', type: 'section',
  ...
  {
    id: 's_sueldos', label: 'SUELDOS', type: 'section',
  ...
  {
    id: 's_gpers', label: 'GASTOS PERSONAL', type: 'section',
  ...
  {
    id: 's_gadm', label: 'GASTOS ADMINISTRATIVOS', type: 'section',
  ...
  {
    id: 's_gmkt', label: 'GASTOS MARKETING', type: 'section',
  ...
  {
    id: 's_terc', label: 'TERCERIZADOS', type: 'section',
  ...
  {
    id: 's_imp', label: 'IMPUESTOS Y GASTOS', type: 'section',
  ...
  {
    id: 's_div', label: 'DIVIDENDOS', type: 'section',
