...
import { uploadTransactionsCSV } from '@/app/admin/actions'

export function TransactionCSVUpload() {
  ...
  return (
    <div>
      <div style={{
        ...
        <code>fecha, sociedad, neto, tipo, categoria, sub_categoria, razon_social, cuit, nro_factura, importe_neto_gravado, importe_no_grav, iva21, total_iva, total_facturado, observaciones</code>
        <br /><br />
        <strong>Notas:</strong><br />
        • <code>fecha</code>: formato YYYY-MM-DD (ej: 2026-03-15)<br />
        • <code>sociedad</code>: TG, CDS o VA<br />
        • <code>tipo</code>: Ingreso, Egreso o Sueldo<br />
        • <code>sub_categoria</code> puede estar vacía<br />
        • El archivo es rechazado completo si alguna fila tiene un error — no se insertan filas parciales
      </div>
